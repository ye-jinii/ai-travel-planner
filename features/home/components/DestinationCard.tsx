...
export function DestinationCard({ destination }: DestinationCardProps) {
  return (
    <article className="group relative rounded-2xl border border-white/70 bg-white/90 p-5 shadow-[0_14px_30px_rgba(15,32,70,0.08)] backdrop-blur transition hover:-translate-y-1">
      ...
      <Link
        ...
        className="absolute inset-0 rounded-2xl outline-none focus-visible:ring-2 focus-visible:ring-sky-400/70"
